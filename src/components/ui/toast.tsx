...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-0 right-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-auto sm:top-0 sm:flex-col md:max-w-[420px]",
      className
    )}
    {...props}
  />
...
>(({ className, variant = "default", ...props }, ref) => (
  <ToastPrimitives.Root
    ...
    className={cn(
      ...
      "data-[state=open]:animate-in data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-right-full",
